...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-50">
      <div className="section-container container mx-auto px-4 sm:px-8 lg:px-8 py-16">
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm">
              Copyright © {new Date().getFullYear()} sknayeemislam384@gmail.com
            </p>
            <p className="text-gray-600 text-sm">Created by Sk Nayeem Islam</p>
          </div>
        </div>
      </div>
    </footer>
